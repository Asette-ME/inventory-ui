      ...
      <InputGroupAddon align="inline-end">
        {showTrigger && (
          <InputGroupButton
            ...
            className={cn('group-has-data-[slot=combobox-clear]/input-group:hidden data-pressed:bg-transparent')}
            disabled={disabled}
          >
            <ComboboxTrigger />
          </InputGroupButton>
      ...
      >
        <ComboboxPrimitive.Popup
          ...
          className={cn(
            ...
            'ring-foreground/10 group/combobox-content relative max-h-96',
            'w-(--anchor-width) max-w-(--available-width) min-w-[calc(var(--anchor-width)+--spacing(7))]',
            'origin-(--transform-origin) overflow-hidden rounded-md shadow-md ring-1 duration-100',
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        ...
        'flex min-h-9 flex-wrap items-center gap-1.5 rounded-md border bg-transparent bg-clip-padding',
        'px-2.5 py-1.5 text-sm shadow-xs transition-[color,box-shadow]',
        'focus-within:ring-[3px] has-aria-invalid:ring-[3px] has-data-[slot=combobox-chip]:px-1.5',
        className,
      )}
      {...props}
    />
