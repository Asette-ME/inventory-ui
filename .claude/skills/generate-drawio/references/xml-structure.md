...
2. [mxGraphModel Attributes](#mxgraphmodel-attributes)
3. [Element Types](#element-types)
4. [Common Style Properties](#common-style-properties)
5. [Predefined Shapes](#predefined-shapes)
6. [Font Recommendations](#font-recommendations)
7. [Coordinate System](#coordinate-system)
8. [Z-Order (Layering)](#z-order-layering)
9. [Special Characters](#special-characters-in-values)
