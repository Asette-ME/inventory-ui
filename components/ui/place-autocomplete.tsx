...
interface PlaceAutocompleteProps
  extends Omit<PlaceSearchOptions, 'query'>, Omit<React.ComponentProps<'input'>, 'value' | 'onChange'> {
  debounceMs?: number;
  value?: string;
  defaultValue?: string;
...
function usePlaceSearch({
  ...
  }, [debouncedQuery, props.lang, props.limit, props.bbox, props.lat, props.lon, props.zoom, props.locationBiasScale]);
